...
namespace EmpXpo.Accounting.SellerApi.Controllers
{
    [Route("api/Sellers")]
    [ApiController]
    public class SellerController : ControllerBase
    {
        ...
        /// <response code="400">Seller has missing/invalid values</response>
        ...
        public async Task<IActionResult> Update(int id, [FromBody]SellerModel model)
        {
            ...
            return Ok(await _sellerApplication.Update(id, _mapper.Map<Seller>(model)));
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            return Ok(await _sellerApplication.Delete(id));
        }
    }
}
