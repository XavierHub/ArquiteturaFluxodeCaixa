...
namespace CashFlowApiTests.Application
{
    public class CashFlowApplicationTest
    {
        ...
        public async Task WhenRunCreateWithInvalidValues_ShouldThrowException()
        {
            ...
            await Assert.ThrowsAsync<EmpXpo.Accounting.Domain.Exceptions.DomainException>(async () => await _cashFlowApplication.Create(model));
        }
        ...
        {
            await Assert.ThrowsAsync<EmpXpo.Accounting.Domain.Exceptions.DomainException>(async () => await _cashFlowApplication.Create(null));
        }
